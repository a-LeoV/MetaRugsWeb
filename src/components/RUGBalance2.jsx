...
<div className="home container">
      ...
      >
        ...
        <h2>
        You have been provably rugged <span className="startup_blue"> { totalNFTs } </span> times
        </h2>
        <div>
        </div>
        <h2>
        You can mint a <span className="startup_blue"> MetaRug </span> for each CryptoRug you burn.
        </h2>
